              ...
              child: Column(
                children: [
                  ...
                  const ProductInfoWidget(
                    ...
                    reviewsCount: 4,
                    description:
                        'Crafted from soft cotton for an effortless feel, this Calvin Klein t-shirt features an oversized monogram logo for an iconic, retro-inspired look. Detailed with a crewneck, a straight hem and twin-needle topstitching in a wide array of colors.',
                  ),
                  const LineSpaceWidget(),
                  const DialogName(
                      title: 'Product Details', icon: Icons.shopping_bag),
                  const DialogName(
                      title: 'Shopping Information',
                      icon: Icons.directions_bus),
                  const DialogName(
                      title: 'Returns', icon: Icons.backpack_outlined),
                  RatingSummaryWidget(
                      averageRating: 3.4,
                      totalReviews: 5,
                      ratingsDistribution: const [0, 0.1, 0.2, 0.3, 0.8]),
                  const LineSpaceWidget(),
